...
final class S5AlarmGenerator
  ...
  @Override
  public IList<IS5AlarmProfile> getAlarmProfiles() {
    return (IList<IS5AlarmProfile>)(Object)profiles;
  }

  @Override
  public IS5AlarmProfile addAlarm( Skid aAuthorId, ISkAlarmDef aSkAlarmDef, Predicate<IS5AlarmProfile> aPredicate ) {
    ...
    S5AlarmProfile retValue = new S5AlarmProfile( this, aSkAlarmDef, aAuthorId, aPredicate );
    profiles.add( retValue );
    // Запись в журнал
