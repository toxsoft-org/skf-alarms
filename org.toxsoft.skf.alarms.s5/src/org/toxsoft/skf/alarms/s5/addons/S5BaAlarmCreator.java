...
import org.toxsoft.skf.alarms.lib.ISkAlarmHardConstants;
import org.toxsoft.skf.alarms.lib.impl.SkAlarmService;
import org.toxsoft.skf.alarms.s5.S5AlarmValobjUtils;
import org.toxsoft.skf.alarms.s5.supports.S5BackendAlarmSingleton;
...
public class S5BaAlarmCreator
  ...
  public S5BaAlarmCreator() {
    super( ISkAlarmHardConstants.BAINF_ALARMS );
  }
