...
import static org.toxsoft.skf.alarms.lib2.l10n.ISkAlarmSharedResources.*;
...
public interface ISkAlarmConstants {
  ...
  String EVPRMID_ALARM_MESSAGE   = "alarmMessage";  //$NON-NLS-1$
  String EVPRMID_ACK_AUTHOR_GWID = "ackAuthorGwid"; //$NON-NLS-1$
  String EVPRMID_ACK_REASON      = "ackReason";     //$NON-NLS-1$
  ...
  IDataDef EVPRMDEF_ALARM_MESSAGE = DataDef.create( EVPRMID_ALARM_MESSAGE, STRING, //
      TSID_NAME, STR_ALARM_MESSAGE, //
      TSID_DESCRIPTION, STR_ALARM_MESSAGE_D, //
